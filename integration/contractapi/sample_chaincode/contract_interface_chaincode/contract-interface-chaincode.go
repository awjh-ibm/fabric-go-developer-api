...
func (sa *SimpleAsset) GetUnknownTransaction() (interface{}, error) {
	return handleUnknown, nil
}

// GetBeforeTransaction returns getAsset func
func (sa *SimpleAsset) GetBeforeTransaction() (interface{}, error) {
	return getAsset, nil
}

// GetAfterTransaction returns nothing
func (sa *SimpleAsset) GetAfterTransaction() (interface{}, error) {
	return nil, nil
}
...
// GetTransactionContextHandler returns custom transaction context
func (sa *SimpleAsset) GetTransactionContextHandler() contractapi.TransactionContextInterface {
