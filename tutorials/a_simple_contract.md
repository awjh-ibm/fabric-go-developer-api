...
The first argument of invoke is the contract and function you wish to call separated by a colon. In this case the contract is "contracts.Simple" and function "Create". The remaining arguments are the values to be passed to the function so in the case of create the key and value parameters. Note that you do not pass the transaction context, this is generated by the running chaincode to be passed to your contract function.
